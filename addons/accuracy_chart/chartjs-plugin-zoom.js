...
var zoomPlugin = {
	...
	afterInit: function(chartInstance) {
		...
		chartInstance.doZoom = function(xPercent, yPercent, center, axes = 'xy') {
			doZoom(chartInstance, xPercent, yPercent, center, axes);
		};

		chartInstance.doPan = function(deltaX, deltaY) {

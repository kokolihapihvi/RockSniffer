...
var app = new Vue({
	...
	computed: {
		...
		scrDisplay: function(){
			...
			var scr = this.notes.CurrentScore;
			var PerfP = this.notes.PerfectPhrases;
			var GP = this.notes.GoodPhrases;
			var PP = this.notes.PassedPhrases;
			var FP = this.notes.FailedPhrases;
			score = score + String(scr);
			if((songProg >= 80 & (GP + PP + FP) == 0 & PerfP > 0) | scr >= 1500000){
				$("div.scrDisplay").css({
			...
			} else if((songProg >= 70 & GP < 2 & (PP + FP) == 0 & PerfP > 2*GP) | scr >= 1000000){
				$("div.scrDisplay").css({
			...
			} else if ((songProg >= 60 & GP < 3 & PP < 2 & FP == 0 & PerfP > (2*GP + 4*PP)) | scr >= 750000){		
				$("div.scrDisplay").css({		
			...
			} else if ((songProg >= 50 & GP < 4 & PP < 3 & FP == 0 & PerfP > (2*GP + 4*PP)) | scr >= 500000){
				$("div.scrDisplay").css({
		...
		mltDisplay: function(){
			...
			var curM = this.notes.CurrentMultiplier;
			var maxM = this.notes.HighestMultiplier;
			var acc = this.notes.Accuracy;
			var maxM_POS = ((this.notes.TotalNotes)/5) + 1;
		...
		scrDisplayF: function(){
			...
			var PerfP = this.prevNotes.PerfectPhrases;
			var GP = this.prevNotes.GoodPhrases;
			var PP = this.prevNotes.PassedPhrases;
			var FP = this.prevNotes.FailedPhrases;
			var scr = this.prevNotes.CurrentScore;
			score = score + String(scr);	
			if(acc == 100){
				$("div.scrDisplay").css({
			...
			} else if (scr >= 1500000 | ((GP + PP + FP) == 0 & PerfP > 0 )){
				$("div.scrDisplay").css({
					"background": "repeating-linear-gradient(180deg, #c1beba, #d9d8d4, #e5e4e2, #fdfdfd, #e5e4e2, #d9d8d4, #c1beba, #d9d8d4, #e5e4e2, #fdfdfd, #e5e4e2, #d9d8d4, #c1beba, #d9d8d4, #e5e4e2, #fdfdfd, #e5e4e2, #d9d8d4)",
					"background-size": "100% 24px",
					"-webkit-text-fill-color": "transparent",
			...
			} else if (scr >= 1000000 | (GP < 2 & (PP + FP) == 0 & PerfP > 2*GP)){
				$("div.scrDisplay").css({
					"background": "repeating-linear-gradient(180deg, #fcb400, #fcd855, #fcfcaa, #fcfcfc, #fcfcaa, #fcd855, #fcb400, #fcd855, #fcfcaa, #fcfcfc, #fcfcaa, #fcd855, #fcb400, #fcd855, #fcfcaa, #fcfcfc, #fcfcaa, #fcd855)",
					"background-size": "100% 24px",
					"-webkit-text-fill-color": "transparent",
			...
			} else if (scr >= 750000 | (GP < 3 & PP < 2 & FP == 0 & PerfP > (2*GP + 4*PP))){
				$("div.scrDisplay").css({				
					"background": "repeating-linear-gradient(180deg, #9a9a9a, #b3b3b3, #c0c0c0, #dadada, #c0c0c0, #b3b3b3, #9a9a9a, #b3b3b3, #c0c0c0, #dadada, #c0c0c0, #b3b3b3, #9a9a9a, #b3b3b3, #c0c0c0, #dadada, #c0c0c0, #b3b3b3)",
					"background-size": "100% 24px",
					"-webkit-text-fill-color": "transparent",
			...
			} else if (scr >= 500000 | (GP < 4 & PP < 3 & FP == 0 & PerfP > (2*GP + 4*PP))){
				$("div.scrDisplay").css({
					"background": "repeating-linear-gradient(180deg, #d89000, #d8b400, #d8d855, #d8fcaa, #d8d855, #d8b400, #d89000, #d8b400, #d8d855, #d8fcaa, #d8d855, #d8b400, #d89000, #d8b400, #d8d855, #d8fcaa, #d8d855, #d8b400)",
					"background-size": "100% 24px",
					"-webkit-text-fill-color": "transparent",
		...
		mltDisplayF: function(){
			...
			var curMlt = '00';
			var maxMlt = '00';
			var maxM = this.prevNotes.HighestMultiplier;
			var maxM_POS = ((this.prevNotes.TotalNotes)/5) + 1;
			maxMlt = maxMlt + String(maxM);	
			...
			} else if(maxM/maxM_POS >= .5 | maxM == 99){
				$("div.mltDisplay").css({
					"background": "repeating-linear-gradient(180deg, #c1beba, #d9d8d4, #e5e4e2, #fdfdfd, #e5e4e2, #d9d8d4, #c1beba, #d9d8d4, #e5e4e2, #fdfdfd, #e5e4e2, #d9d8d4, #c1beba, #d9d8d4, #e5e4e2, #fdfdfd, #e5e4e2, #d9d8d4)",
					"background-size": "100% 24px",
					"-webkit-text-fill-color": "transparent",
			...
			} else if(maxM/maxM_POS >= .45 | maxM >= 95){
				$("div.mltDisplay").css({
					"background": "repeating-linear-gradient(180deg, #fcb400, #fcd855, #fcfcaa, #fcfcfc, #fcfcaa, #fcd855, #fcb400, #fcd855, #fcfcaa, #fcfcfc, #fcfcaa, #fcd855, #fcb400, #fcd855, #fcfcaa, #fcfcfc, #fcfcaa, #fcd855)",
					"background-size": "100% 24px",
					"-webkit-text-fill-color": "transparent",
			...
			} else if(maxM/maxM_POS >= .4 | maxM >= 90){
				$("div.mltDisplay").css({
					"background": "repeating-linear-gradient(180deg, #9a9a9a, #b3b3b3, #c0c0c0, #dadada, #c0c0c0, #b3b3b3, #9a9a9a, #b3b3b3, #c0c0c0, #dadada, #c0c0c0, #b3b3b3, #9a9a9a, #b3b3b3, #c0c0c0, #dadada, #c0c0c0, #b3b3b3)",
					"background-size": "100% 24px",
					"-webkit-text-fill-color": "transparent",
			...
			} else if(maxM/maxM_POS >= 1/3 | maxM >= 80){
				$("div.mltDisplay").css({
					"background": "repeating-linear-gradient(180deg, #d89000, #d8b400, #d8d855, #d8fcaa, #d8d855, #d8b400, #d89000, #d8b400, #d8d855, #d8fcaa, #d8d855, #d8b400, #d89000, #d8b400, #d8d855, #d8fcaa, #d8d855, #d8b400)",
					"background-size": "100% 24px",
					"-webkit-text-fill-color": "transparent",
